			...
			<div id="contents">
				<div id="contentsDetail" class="clearfix">
					<div id="TitleName">
                        ...
                        <input name="listType" type="hidden" value="R"/>
                    ...
                    <div id="TitleContents">
                       <a href="/approvalForm.ho?docuType=H" id="new-apr-btn">+ 새 결재문서</a>
                        <ul id="apr-list-filter">
                            <li><a href="/approvalList.ho?listType=R">전체목록</a></li>
                            <li><a href="/approvalList.ho?listType=R&aprStatus=W">대기</a></li>
                            <li><a href="/approvalList.ho?listType=R&aprStatus=I">진행중</a></li>
                            <li><a href="/approvalList.ho?listType=R&aprStatus=R">반려</a></li>
                            <li><a href="/approvalList.ho?listType=R&aprStatus=C">완료</a></li>
                        </ul>
