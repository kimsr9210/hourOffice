                        ...
                        <table id="mail-docu-list">
                            ...
                            <c:forEach var="mail" items="${requestScope.mailList.list }">
	                            <tr>
	                                ...
	                                <td><div class="mail-title"><a href="/mailView.ho?mailNo=${mail.mailNo }&other=${mail.recMemNo}&listType=R&readYN=${mail.readYN}"><c:choose><c:when test="${mail.title !=null }">${mail.title}</c:when><c:otherwise>(제목없음)</c:otherwise></c:choose></a></div></td>
	...
	<script>
        $(function(){
            ...
            $('.fa-star').click(function(){
                ...
                $.ajax({
                	url : "/changeKeepYN.ho",
                	data : {"keepYN": keepYN, "mailNo":mailNo, "listType":'R'},
                	type : "get",
            ...
            $('i[class*=fa-envelope]').click(function(){
                ...
                $.ajax({
                	url : "/changeReadYN.ho",
                	data : {"readYN": readYN, "mailNo":mailNo, "listType":'R'},
                	type : "get",
                	success : function(result){
                		if(result){
	                		if(readYN=='Y'){
