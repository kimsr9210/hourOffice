				...
				<div id="contentsDetail" class="clearfix">
                    ...
                    <div id="TitleContents">
                      <div id="mail_btn_wrap">
                                <span id="mail_fdel_btn">영구삭제</span>
                                <span id="mail_read_btn">읽음</span>
                                <span id="mail_res_btn">복원</span>
                            </div>
                        ...
                        <table id="mail-docu-list">
                            ...
                            <c:forEach var="mail" items="${requestScope.mailList.list }">
	                            <tr>
	                                ...
	                                <td><div class="mail-title"><a href="/mailView.ho?mailNo=${mail.mailNo }&other=${mail.recMemNo}&listType=${mail.listType }D&readYN=${mail.readYN}"><c:choose><c:when test="${mail.listType=='R'.charAt(0) }">[받은메일함]</c:when><c:when test="${ mail.listType=='F'.charAt(0)}">[참조메일함]</c:when></c:choose>
